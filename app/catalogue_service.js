...
const catalogue = [
  ...
  { title: "Everything I Never Told", author: "Celeste Ng", quantity: 6 },
  ...
  { title: "The Yellow Wallpaper", author: "Charlotte Perkins", quantity: 12 },
...
function checkBookByTitle(title) {
  ...
  for (let i = 0; i < catalogue.length; i++){
    if (check = catalogue[i].title === title) return true;
  };
  return false;
};
